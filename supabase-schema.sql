...
create table courses (
  ...
  textbook text not null default '자체 교재'
);
...
create table admins (
  ...
  name text not null,
  role text not null check (role in ('admin', 'super_admin', 'teacher')),
  cohort_id text
);
...
('kor-basic', 'KOR-101', 'season-3', '국어', '독서 기본기 회복', '정하늘', '3-4등급', 2, 24, 0, '[{"day": "월", "block": "A", "time": "08:20-10:00"}, {"day": "수", "block": "A", "time": "08:20-10:00"}]'::jsonb, '지문 구조 읽기와 선지 판단 루틴을 반복합니다.', '301호 (3층)', '독서 기본 패턴'),
('math-basic', 'MAT-201', 'season-3', '수학', '수학 공통 개념 압축', '한도윤', '4등급 이하', 2, 20, 0, '[{"day": "월", "block": "B", "time": "10:20-12:00"}, {"day": "목", "block": "A", "time": "08:20-10:00"}]'::jsonb, '수1, 수2의 빈출 개념을 문제 풀이 흐름으로 정리합니다.', '302호 (3층)', '수학 공통 압축 개념'),
('eng-reading', 'ENG-110', 'season-3', '영어', '영어 빈칸과 순서', '오유진', '2-3등급', 2, 28, 0, '[{"day": "화", "block": "B", "time": "10:20-12:00"}, {"day": "목", "block": "B", "time": "10:20-12:00"}]'::jsonb, '논리 연결어와 문장 기능을 기준으로 고난도 유형을 풉니다.', '303호 (3층)', '영어 독해 실전편'),
('math-advanced', 'MAT-330', 'season-3', '수학', '미적분 실전 N제', '강서준', '1-2등급', 2, 18, 0, '[{"day": "화", "block": "C", "time": "14:30-16:10"}, {"day": "금", "block": "C", "time": "14:30-16:10"}]'::jsonb, '준킬러와 킬러 문항의 발상 전환을 훈련합니다.', '401호 (4층)', '미적분 N제 200제'),
('science-life', 'SCI-210', 'season-3', '과학탐구', '생명과학 도표 특강', '문채원', '전체', 1, 30, 0, '[{"day": "수", "block": "D", "time": "16:30-18:10"}]'::jsonb, '유전, 신경, 항상성 도표를 시간 안에 처리하는 강좌입니다.', '402호 (4층)', '생명과학 도표 비급'),
('social-culture', 'SOC-120', 'season-3', '사회탐구', '사회문화 자료 분석', '서지윤', '전체', 1, 30, 0, '[{"day": "목", "block": "D", "time": "16:30-18:10"}]'::jsonb, '표, 그래프, 개념 비교 문항을 빠르게 분류하고 풉니다.', '501호 (5층)', '사회문화 자료분석특강'),
('kor-literature', 'KOR-240', 'season-3', '국어', '문학 선지 감각', '백소은', '전체', 1, 26, 0, '[{"day": "금", "block": "B", "time": "10:20-12:00"}]'::jsonb, '작품 암기가 아니라 표현과 정서의 판단 기준을 세웁니다.', '502호 (5층)', '문학 선지 개념서');
...
-- Seed admins
insert into admins (id, email, password, name, role, cohort_id) values
('admin-1', 'admin@etoos247.kr', '$2b$10$F3pwGlGUQWg9Ci/5dEmNb.TN3OzNu.Al0qxPw1RilEdBYhPjfkSIG', '관리자', 'admin', null),
('admin-2', 'super@etoos247.kr', '$2b$10$5lhpQRcTjuESZpE/B5rUAOZbwfcaOseU37ez1m5sB6Th2XErN2M5S', '최고관리자', 'super_admin', null),
('teacher-1', 'teacher@etoos247.kr', '$2b$10$qdewfa1MleHf3C2XgvGDpO34G4pdj/XPyeshNFF8zrAWBBkL6W3tK', '담임교사', 'teacher', '2027-final-6');
