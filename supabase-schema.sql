...
('math-basic', 'MAT-201', '수학', '수학 공통 개념 압축', '한도윤', '4등급 이하', 2, 20, 0, '[{"day": "월", "block": "B", "time": "10:20-12:00"}, {"day": "목", "block": "A", "time": "08:20-10:00"}]'::jsonb, '수1, 수2의 빈출 개념을 문제 풀이 흐름으로 정리합니다.'),
